...
import 'package:buy_it_flutter_app/functions.dart';
...
//class GridProductItemUsers extends StatelessWidget {
//  //String image, name, price,
//  // documentId;
//  String type;
//  Map<String ,String>  _productData;
//  GridProductItemUsers(this.type,this._productData);
//
//  List<String> _productDataList=convertMapToList(_productData);
//  final _store=Store();
//  @override
